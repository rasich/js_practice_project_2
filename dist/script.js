...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  window.addEventListener('click', function (e) {
    if (!e.target.closest('.burger-menu') && !(e.target.className == 'burger' || e.target.parentElement.className == 'burger')) {
      menuElem.style.display = 'none';
    }
  });
};
...
var filter = function filter() {
  ...
  no = document.querySelector('.portfolio-no'); // const typeFilter = () => {
...
var scrolling = function scrolling(upSelector) {
  ...
  links.forEach(function (link) {
    if (link.getAttribute('href') != '#') link.addEventListener('click', function (e) {
      e.preventDefault;
